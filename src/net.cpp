...
CNode* ConnectNode(CAddress addrConnect, const char *pszDest, bool legacySendMaster)
{
    if (pszDest == NULL) {
        // we clean masternode connections in CMasternodeMan::ProcessMasternodeConnections()
        // so should be safe to skip this and connect to local Hot MN on CActiveMasternode::ManageStatus()
        if (IsLocal(addrConnect) && !legacySendMaster)
            return NULL;
        ...
        if (pnode)
        {
            pnode->fLegacySendMaster = legacySendMaster;
                  ...
                  ConnectSocket(addrConnect, hSocket, nConnectTimeout, &proxyConnectionFailed))
    {
        ...
        if(legacySendMaster) pnode->fLegacySendMaster = true;
