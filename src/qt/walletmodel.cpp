...
void WalletModel::pollBalanceChanged()
{
    ...
    if(fForceCheckBalanceChanged || chainActive.Height() != cachedNumBlocks || nLegacysendRounds != cachedLegacysendRounds || cachedTxLocks != nCompleteTXLocks)
    {
        fForceCheckBalanceChanged = false;

        // Balance and number of transactions might have changed
        cachedNumBlocks = chainActive.Height();
        cachedLegacysendRounds = nLegacysendRounds;
